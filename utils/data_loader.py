...
def extract_text_from_pdf(file_path: str) -> Optional[str]:
    ...
    """This function try to extract text from pdf by PdfReader, if there not too much text found 
    Try to extract text by EasyOcr"""
    try:
...
def load_and_parse_files(input_dir: str) -> List[Dict[str, any]]:
    ...
    for file_path in input_path.rglob("*.*"):
        if file_path.is_file():
            ...
            # extract the extention of file to know which method to use
